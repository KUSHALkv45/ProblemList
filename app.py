...
GITHUB_REPO  = st.secrets["GITHUB_REPO"]   # e.g. "username/repo-name"
FILE_PATH    = st.secrets.get("FILE_PATH", "data.json")  # path inside repo
...
if submit:
    if not title.strip():
        ...
        with st.spinner("Saving to GitHub…"):
            ...
            problems, sha = get_file()   # refresh sha after write
...
if not sorted_problems:
    ...
    for i, prob in enumerate(sorted_problems):
